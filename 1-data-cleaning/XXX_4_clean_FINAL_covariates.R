...
d$birthlen2 <- who_zscore2value(d$birthmeas_age-1, d$birthLAZ, y_var = "lenhtcm",
                                x_var = "agedays", sex = d$sex)
...
#Check if children without a recorded birthweight or birthlength have WAZ or HAZ
# in the first 7 days of life and add into birthweight variable
