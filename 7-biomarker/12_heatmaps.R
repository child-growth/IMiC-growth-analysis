...
select_and_plot_top_features(hmoE, n_features = 22, 
                             file_name = paste0(here::here(), "/figures/heatmaps/hmoE.png")
select_and_plot_top_features(biocNormE, n_features = 60, 
                             file_name = paste0(here::here(), "/figures/heatmaps/biocNormE.png")
select_and_plot_top_features(bvitE, n_features = 23, 
                             file_name = paste0(here::here(), "/figures/heatmaps/bvitE.png")
select_and_plot_top_features(metabolE, n_features = 60, 
                             file_name = paste0(here::here(), "/figures/heatmaps/metabolE.png")
select_and_plot_top_features(sapientE, n_features = 60, 
                             file_name = paste0(here::here(), "/figures/heatmaps/sapientE.png")


# Call the function on vital data
select_and_plot_top_features(hmoV, n_features = 22, 
                             file_name = paste0(here::here(), "/figures/heatmaps/hmoV.png")
select_and_plot_top_features(biocNormV, n_features = 60, 
                             file_name = paste0(here::here(), "/figures/heatmaps/biocNormV.png")
select_and_plot_top_features(pblV, n_features = 60, 
                             file_name = paste0(here::here(), "/figures/heatmaps/pblV.png")
select_and_plot_top_features(metabolV, n_features = 60, 
                             file_name = paste0(here::here(), "/figures/heatmaps/metabolV.png")
select_and_plot_top_features(sapientV, n_features = 60, 
                             file_name = paste0(here::here(), "/figures/heatmaps/sapientV.png")
